            ...
            <div class="panel-body">
                ...
                <div class="adv-table">
                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <tbody>
                        <?php $i=1; ?>
                        @foreach($highlandSimDatas as $data)
                            <tr>
                                <td>{{$i++}}</td>
                                <td>{{$data->highland_id}}</td>
            ...
            <div class="modal-body">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            {!! Form::open(array('url' => PREFIX.'/simRecord/pages/highlandSim/postData','method'=>'POST', 'name'=>'myForm','files'=>true,'class'=>'cmxform form-horizontal')) !!}
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <a class="btn-success" href="{{url(PREFIX.'/simRecord/pages/highlandSim/downloadSample')}}">Download sample</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
