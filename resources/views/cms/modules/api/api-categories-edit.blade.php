                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                              ...
                              @endif
                                ...
                                <div class="col-sm-12">
                            {!! Form::open(array('url' => PREFIX.'/api/pages/categories/editPost','method'=>'POST', 'name'=>'myForm', 'class'=>'cmxform form-horizontal')) !!}
                                
                                            {!! Form::hidden('id',$apiCatFormData->id) !!}
                                        <div class="col-lg-12">
                                          ...
                                          {!! Form::label('title','Category Title:',['class'=>'control-label col-lg-4']) !!}
                                           <div class="col-lg-8">
                                             <div class="form-group">
                                                  ...
                                                  {!! Form::text('title',$apiCatFormData->title,['class'=>'form-control']) !!}
                                             </div>
                                           </div>
                                        </div>
