                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                              ...
                              @endif
                                ...
                                <div class="col-sm-12">
                            {!! Form::open(array('url' => PREFIX.'/api/pages/types/addPost', 'method'=>'POST', 'name'=>'myForm', 'class'=>'cmxform form-horizontal', 'id'=>'commentForm','files'=>true)) !!}
                                ...
                                <div class="col-lg-12">
                                          ...
                                          {!! Form::label('API_Name','API Name:',['class'=>'control-label col-lg-4']) !!}
                                           <div class="col-lg-8">
                                             <div class="form-group">
                                                  ...
                                                  {!! Form::text('api_name','',['class'=>'form-control']) !!}
                                             </div>
                                           </div>
                                        </div>
                                          ...
                                          {!! Form::label('API_cat','API Category:',['class'=>'control-label col-lg-4']) !!}
                                           <div class="col-lg-8">
                                             <div class="form-group">
                                                 ...
                                                 {!! Form::select('category_id', $apiCategories ,null,['class'=>'form-control']) !!}
                                             </div>
                                           </div>
                                        </div>
                                          ...
                                          {!! Form::label('API_ID','API ID:',['class'=>'control-label col-lg-4']) !!}
                                           <div class="col-lg-8">
                                             <div class="form-group">
                                                  ...
                                                  {!! Form::text('api_id','',['class'=>'form-control']) !!}
                                             </div>
                                           </div>
                                        </div>
                                          ...
                                          {!! Form::label('api_type','TYPE:',['class'=>'control-label col-lg-4']) !!}
                                           <div class="col-lg-8">
                                             <div class="form-group">
                                                  ...
                                                  {!! Form::text('api_type','',['class'=>'form-control']) !!}
                                             </div>
                                           </div>
                                        </div>
                                          ...
                                          {!! Form::label('API_method','API Method:',['class'=>'control-label col-lg-4']) !!}
                                           <div class="col-lg-8">
                                             <div class="form-group">
                                                 ...
                                                 {!! Form::select('api_method', ['POST'=>'POST','GET'=>'GET','PUT'=>'PUT','DELETE'=>'DELETE'] ,null,['class'=>'form-control']) !!}
                                             </div>
                                           </div>
                                        </div>
                                          ...
                                          {!! Form::label('api_desc','API Description:',['class'=>'control-label col-lg-4']) !!}
                                           <div class="col-lg-8">
                                             <div class="form-group">
                                                  ...
                                                  {!! Form::textarea('api_description','',['class'=>'form-control']) !!}
                                             </div>
                                           </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                          ...
                                          {!! Form::label('api_desc','Manual Response:',['class'=>'control-label col-lg-4']) !!}
                                           <div class="col-lg-8">
                                             <div class="form-group">
                                                
                                                  {!! Form::textarea('manual_response','',['class'=>'form-control']) !!}
                                             </div>
                                           </div>
                                        </div>
