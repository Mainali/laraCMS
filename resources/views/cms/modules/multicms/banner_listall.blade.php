...
<div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <a href="{{URL::to(PREFIX.'/multicms/pages/banner/create')}}" class="btn btn-primary btn-sm" style="float:right; margin-top:5px;"> + Add New </a>

                        <ul class="breadcrumbs-alt">
                        
                        <li>
                            <a class="current" href="javascript:void(0)">Banners</a>
                        </li>
                        </ul>
                        ...
                        <section id="unseen">
                            ...
                            <table  class="display table table-bordered table-striped" id="dynamic-table">
                                ...
                                <tr>
                                    ...
                                    <th style="width:50%" class="numeric">Title</th>
                                    <th style="width:10%" class="numeric">Position</th>
                                ...
                                <tbody>
                                       ...
                                       <td>
                                        ...
                                        <td class="numeric">
                                        <a href="{{ URL::to(PREFIX.'/multicms/pages/banner/manageBanner')}}?id=<?= $data->id;?>" class="btn btn-primary btn-xs">Manage Banner</a> 
                                        <!-- <a href="{{ URL::to(PREFIX.'/multicms/pages/banner/edit')}}?id=<?= $data->id;?>" class="btn btn-success btn-xs"><i class="fa fa-refresh"></i> Update</a> -->
                                        <a href="#" data-href="{{ URL::to(PREFIX.'/multicms/pages/banner/destroy')}}?id=<?= $data->id;?>" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete </a>
                                        </td>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>You are about to delete this banner.</p>
    ...
    <script type="text/javascript">
      ...
      //   $.ajax
      //       ({ 
      //           url: "{{ URL::to(PREFIX.'/multicms/pages/banner/toggleStatus')}}?id="+id,
      //           type: 'get',
