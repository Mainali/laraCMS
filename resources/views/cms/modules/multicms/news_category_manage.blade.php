            ...
            <div class="col-sm-12">
                ...
                <header class="panel-heading">
                	<ul class="breadcrumbs-alt">
                        ...
                        <li>
                            <a class="current" href="javascript:void(0)">Manage:News Category</a>
                        </li>
                    </ul>
                </header>
          {!!Form::open(['files'=>true,'method'=>'POST','url'=>PREFIX.'/multicms/pages/news/categoryAllUpdate','class'=>'form-horizontal'])!!}
            <div class=" form">
                ...
                <div class="tab-section">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-12">
                         ...
                         <!--start news_category updateform-->
                                    <input type="hidden" name="form[newsCategory][id]" value="{{$newsCategory->id}}">
                                    ...
                                    <div class="col-lg-12">
                                          ...
                                          <div class="col-lg-8">
                                            <div class="form-group">
                                                {!! Form::text('form[newsCategory][default_title]',$newsCategory->default_title,['class'=>'form-control']) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                          ...
                                          <div class="col-lg-8">
                                            <div class="form-group">
                                                {!! Form::text('form[newsCategory][slug]',$newsCategory->slug,['class'=>'form-control','id' => 'slug_input']) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                          ...
                                          <div class="col-lg-8">
                                            <div class="form-group">
                                                {!! Form::text('form[newsCategory][position]',$newsCategory->position,['class'=>'form-control']) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        {!! Form::label('form[newsCategory][status]','Status:',['class'=>'control-label col-lg-4']) !!}
                                          ...
                                          <div class="col-lg-8">
                                            <div class="form-group">
                                            @if($newsCategory->status == 'active')  
                                              {!! Form::radio('form[newsCategory][status]', 'active',true) !!}&nbsp;Active&nbsp;&nbsp;&nbsp;{!! Form::radio('form[newsCategory][status]', 'inactive') !!}&nbsp;Inactive
                                            @else
                                              {!! Form::radio('form[newsCategory][status]', 'active') !!}&nbsp;Active&nbsp;&nbsp;&nbsp;{!! Form::radio('form[newsCategory][status]', 'inactive', true) !!}&nbsp;Inactive
                                            @endif
                                            </div>
                                          </div>
                                    </div>
                         ...
                         <!--close news_category updateform-->
                        ...
                        <div id="{{ucfirst($flag->slug)}}" class="tab-pane fade in active">{{Session::forget('flag')}}@else
                          ...
                          <div id="{{ucfirst($flag->slug)}}" class="tab-pane fade">@endif
                            <div class="panel-body">
                                        ...
                                        @if(count($newsCategory->newsCategoryLg)>0)

                                            @foreach($newsCategory->newsCategoryLg as $Lg)
                                    ...
                                    @if($langMatch == 1)
                                            ...
                                            <!--start news_category_lg updateform-->
                                            ...
                                            <!--close news_category_lg updateform-->
                                    @else
                                            <!--start news_category_lg form-->
