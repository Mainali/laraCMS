            ...
            <div class="col-sm-12">
                ...
                <header class="panel-heading">
                	<ul class="breadcrumbs-alt">
                        ...
                        <li>
                            <a class="current" href="javascript:void(0)">Manage:&nbsp;{{$news->title}}</a>
                        </li>
                    </ul>
                </header>
          {!!Form::open(['files'=>true,'method'=>'POST','url'=>PREFIX.'/multiLanguage/pages/news/allUpdate','class'=>'form-horizontal'])!!}
            <div class=" form">
                ...
                <div class="tab-section">
                    ...
                    <div class="col-lg-12">
                        ...
                        <!--start news updateform-->
                                <input type="hidden" name="form[news][id]" value="{{$news->id}}">
                                ...
                                <div class="col-lg-12">
                                      ...
                                      <div class="col-lg-8">
                                        <div class="form-group">
                                            {!! Form::text('form[news][slug]',$news->slug,['class'=>'form-control','id' => 'slug_input']) !!}
                                        </div>
                                    </div>
                                            ...
                                            <div class="checkbox">
                                              <label>
                                                ...
                                                @if( in_array($key, $cats) )
                                                  {!! Form::checkbox('form[news][categories]['.$i.']', $key,Input::old('form[news][categories]',true)); !!}&nbsp;{{$value}}
                                                @else
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-8">
                                          <div class="form-group">
                                          {!! Form::select('form[news][gallery_id]',$galleryList,$news->gallery_id,['class'=>'form-control']) !!}
                                        </div>
                                      </div>
                                ...
                                <div class="col-lg-12">
                                      ...
                                      <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($news->image!="")
                                          <img src="{{asset('/uploads')}}/news/image/{{$news->image}}" height="50" width="50" style="float:left; margin-right:5px;">
                                          <a class="btn btn-danger btn-xs" href="{{ URL::to(PREFIX.'/news/imageDelete')}}?id=<?= $news->id;?>"><i class="fa fa-trash"></i>Delete Image</a>
                                          @endif
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                      ...
                                      <div class="col-lg-8">
                                        <p>Image Size:370x150</p>
                                        <div class="form-group">
                                            {!! Form::file('form[news][thumbnail]',['class'=>'form-control']) !!}
                                            @if($news->thumbnail!="")
                                            <img src="{{asset('/uploads')}}/news/thumbnail/{{$news->thumbnail}}" height="50" width="50" style="float:left; margin-right:5px;">
                                            <a class="btn btn-danger btn-xs" href="{{ URL::to(PREFIX.'/news/thumbDelete')}}?id=<?= $news->id;?>"><i class="fa fa-trash"></i>Delete Thumbnail</a>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    {!! Form::label('form[news][pinned]','Pinned:',['class'=>'control-label col-lg-4']) !!}
                                      ...
                                      <div class="col-lg-8">
                                        <div class="form-group">
                                        @if($news->pinned == 'yes')  
                                          {!! Form::radio('form[news][pinned]', 'yes',true) !!}&nbsp;Yes&nbsp;&nbsp;&nbsp;{!! Form::radio('form[news][pinned]', 'no') !!}&nbsp;No
                                        @else
                                ...
                                <div class="col-lg-12">
                                      ...
                                      <div class="col-lg-8">
                                        <div class="form-group">
                                            {!! Form::text('form[news][pinned_position]',$news->pinned_position,['class'=>'form-control']) !!}
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                      ...
                                      <div class="col-lg-8">
                                        <div class="form-group">
                                            {!! Form::text('form[news][published_at]',$news->published_at,['class'=>'form-control datepicker']) !!}
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    {!! Form::label('form[news][status]','Status:',['class'=>'control-label col-lg-4']) !!}
                                      ...
                                      <div class="col-lg-8">
                                        ...
                                        @else
                                          {!! Form::radio('form[news][status]', 'active') !!}&nbsp;Active&nbsp;&nbsp;&nbsp;{!! Form::radio('form[news][status]', 'inactive', true) !!}&nbsp;Inactive
                                        @endif
                                        </div>
                                      </div>
                                </div>
                        ...
                        <div id="{{ucfirst($flag->slug)}}" class="tab-pane fade in active">{{Session::forget('flag')}}@else
                          ...
                          <div id="{{ucfirst($flag->slug)}}" class="tab-pane fade">@endif
                            <div class="panel-body">
                                        ...
                                        @if(count($news->newsLg)>0)

                                            @foreach($news->newsLg as $Lg)
                                    ...
                                    @if($langMatch == 1)
                                            ...
                                            <!--start news_lg updateform-->
                                                    ...
                                                    <div class="col-lg-12">
                                                          ...
                                                          <div class="col-lg-8">
                                                            <div class="form-group">
                                                              {!! Form::textarea('form['.$flag->id.'][intro]',$pLg->intro,['class'=>'form-control','id' => 'intro'.$flag->id]) !!}
                                                            </div>
                                                          </div>
                                                    </div>
