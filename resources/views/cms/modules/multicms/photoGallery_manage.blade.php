            ...
            <div class="col-sm-12">
                ...
                <header class="panel-heading">
                    <ul class="breadcrumbs-alt">
                        ...
                        <li>
                            <a class="current" href="javascript:void(0)">Manage:&nbsp;{{$gallery->title}}</a>
                        </li>
                    </ul>
                </header>
          {!!Form::open(['files'=>true,'method'=>'POST','url'=>PREFIX.'/multicms/pages/gallery/allUpdate','class'=>'form-horizontal'])!!}
            <div class=" form">
                ...
                <div class="tab-section">
                    ...
                    <div class="col-lg-12">
                        ...
                        <!--start photoGallery updateform-->
                                

                                <input type="hidden" name="form[gallery][id]" value="{{$gallery->id}}"/>
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-8">
                                          ...
                                          {!! Form::select('form[gallery][parent_id]',$galleryList,$gallery->parent_id,['class'=>'form-control']) !!}
                                        </div>
                                      </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    {!! Form::label('form[gallery][status]','Status:',['class'=>'control-label col-lg-4']) !!}
                                      ...
                                      <div class="col-lg-8">
                                        ...
                                        @else
                                          {!! Form::radio('form[gallery][status]', 'active') !!}&nbsp;Active&nbsp;&nbsp;&nbsp;{!! Form::radio('form[gallery][status]', 'inactive', true) !!}&nbsp;Inactive
                                        @endif
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                      ...
                                      <div class="col-lg-8">
                                        <div class="form-group">
                                        {!! Form::text('form[gallery][slug]',$gallery->slug,['class'=>'form-control','id' => 'slug_input']) !!}
                                      </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                  <div class="col-lg-4"></div>
                                    <div class="col-lg-8">
                                      <img src="{{asset('/uploads')}}/gallery/{{$gallery->cover_pic}}" height="250px">
                                    </div>
                                     </div>
                                @endif
                        ...
                        <div id="{{ucfirst($flag->slug)}}" class="tab-pane fade in active">{{Session::forget('flag')}}@else
                          ...
                          <div id="{{ucfirst($flag->slug)}}" class="tab-pane fade">@endif
                            <div class="panel-body">
                                        ...
                                        @if(count($gallery->photoGalleryLg)>0)

                                            @foreach($gallery->photoGalleryLg as $Lg)
                                    ...
                                    @if($langMatch == 1)
                                            ...
                                            <!--start photoGalleryLg updateform-->
                                            ...
                                            <!--close photoGalleryLg updateform-->
                                     @else
